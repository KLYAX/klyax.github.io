      ...
      [
        {
          ...
          data: `
            <ul>
              ...
              <li>Одночастотный алгоритм регулирования&nbsp;&mdash; бесступенчатое поддержание контролируемого параметра;</li>
              <li>Обеспечивает отслеживание аварийных ситуаций и&nbsp;защитуоборудования;</li>
        ...
        data: [
          {
            ...
            data: `
              ...
              <ul>
                <li><u>Каскадный</u> (ступенчатое поддержание контролируемого параметра)</li>
